...
# Definisi fitur yang akan digunakan
...
# Label encode dan dummy yang stabil
...
# Simpan kolom referensi untuk input user agar selalu konsisten
...
# Encode label dan dummy, pastikan sesuai dengan model training
for col in ['Weekday Type', 'Time Periods', 'Sentiment', 'Age Group', 'Audience Gender']:
