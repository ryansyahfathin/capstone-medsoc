...
uploaded_file = st.file_uploader("Upload dataset engagement sosial media (.xlsx)", type=["xlsx"])
...
if uploaded_file is not None:
    ...
    # Cari jam terbaik berdasarkan data
    ...
    st.info("Silakan upload file dataset Anda terlebih dahulu.")
