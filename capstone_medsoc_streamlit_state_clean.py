...
platform_input = st.selectbox("Pilih Platform", df['Platform'].unique(), key="platform")
post_type_input = st.selectbox("Pilih Jenis Post", df['Post Type'].unique(), key="posttype")
gender_input = st.selectbox("Pilih Gender Target", df['Audience Gender'].unique(), key="gender")
...
# Predict hanya jika tombol ditekan
if st.button("Predict Engagement"):
    st.session_state['predicted'] = True

# Show result only after Predict button clicked
